...
class Curl{
	...
	public function simple_call($method, $url, $params = array(), $options = array())
	{
	...
	public function referral_get()
	{
		...
		if (isset($better_response->status) && ($better_response->status == 'error')) {
			echo $better_response->message;
		}

		if ($better_response->status == 'success') {
			echo $better_response->data->fname;
		}
	}
