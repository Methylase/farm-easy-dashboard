            ...
            <div class="row">
                <div class="col-xl-3 col-md-6">
                    <div class="card bg-primary mb-4">
                        ...
                        <?php echo  isset($farmers) && $farmers !='' ? count($farmers) : "0";?>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card bg-warning text-white mb-4">
                        ...
                        <div class="row">
                            ...
                            <?php echo isset($agents) && $agents !='' ? count($agents) : "0";?>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card bg-success text-white mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 text-gray" style="text-align: right;">
                            <?php echo isset($service_providers) && $service_providers !='' ? count($service_providers) : "0";?>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card bg-danger text-white mb-4">
                        ...
                        <div class="row">
                            ...
                            <?php echo isset($requests) && $requests !='' ? count($requests) : "0";?>
                    ...
                    <table id="datatablesSimple" class="table table-sm table-hover" >
                        ...
                        <?php if(isset($requests) && !empty($requests)){ ?>
                            ...
                            <?php
                                ...
                                if(!empty($this->session->userdata('country')) && $this->session->userdata('country') =='NG'){
                                    $symbol = '&#x20A6 ';
                                }else if(!empty($this->session->userdata('country')) && $this->session->userdata('country') =='TZ'){
                                    $symbol = '&#xa5; ';
                                }
                            ?>
                            <?php if(!empty($this->session->userdata('country')) && $this->session->userdata('country') == $request['country']){ ?>
